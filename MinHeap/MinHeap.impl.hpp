template <typename T>
void Heap::MinHeap<T>::Print(T* arr, size arrSize){
...
template <typename T>
Heap::MinHeap<T>::MinHeap(T arr[], size arrSize){
	Copy(arr, arrSize);
...
template <typename T>
void Heap::MinHeap<T>::Copy(T arr[], size arrSize){
	m_size = arrSize;
	m_arr = new T[m_size];
...
template <typename T>
void Heap::MinHeap<T>::Build(size arrSize){
	m_size = arrSize;
...
template <typename T>
void Heap::MinHeap<T>::Heapify(size Indx){
		// Recursive version
...
template <typename T>
void Heap::MinHeap<T>::Insert(T value){
...
void HeapSort(T* arr, size arrSize){
	Heap::MinHeap<T> ob(arr, arrSize);
	ob.Sort(arr, arrSize);
	ob.Print(arr, arrSize);
}
template <typename T>
void Heap::MinHeap<T>::Sort(T* arr, size arrSize){
	for(size i = 0; i < arrSize; ++i){
		//std::swap(arr[i], Extract());
